...
vim.g.neoformat_enabled_javascript = { 'prettierd', 'prettier', 'jsbeautify', 'standard', 'semistandard', 'prettydiff', 'clangformat', 'esformatter', 'prettiereslint', 'eslint_d', 'denofmt' }
-- Override TS default formatter order
vim.g.neoformat_enabled_javascript = { 'prettierd', 'prettier', 'prettiereslint', 'tsfmt', 'tslint', 'eslint_d', 'clangformat', 'denofmt' }
